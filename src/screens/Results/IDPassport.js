            ...
            <div className="wrapper">
              <div className="row results_id_sig">
                <figure className="results_id">
                  {this.props.resultData['Photo'].length > 0 && (
                    <img
                      alt="idscango"
                      className={'profile'}
                ...
                <figure className="results_sig">
                  {this.props.resultData['Signature'].length > 0 && (
                    <img
                      alt="idscango"
                      className={'signature'}
              ...
              <div className="results_data">
                ...
                {this.props.liveness && (
                  <div className="row">
                    ...
                    {this.props.liveness.LivenessResult && (
                      <div className="data">
                        {this.props.liveness.LivenessResult.LivenessAssessment}
                        {this.appendIfNotEmpty(this.props.liveness.ErrorCode)}
                        {this.appendIfNotEmpty(this.props.liveness.Error)}
                      </div>
                    )}
                    {!this.props.liveness.LivenessResult && (
                      <div className="data">
                        {this.props.liveness.ErrorCode}
                        {this.appendIfNotEmpty(this.props.liveness.Error)}
                      </div>
                    )}
                  </div>
                ...
                {this.props.resultData['Address'] && (
                  <div className="row">
                    ...
                    <div className="data">
                      {this.props.resultData['Address'].replace(
                        /[\u2028]/g,
                        ' '
                      )}
                    </div>
                ...
                {this.props.resultData['Birth Date'] && (
                  <div className="row">
                    ...
                    <div className="data">
                      {moment(
                        this.processDate(this.props.resultData['Birth Date'])
                      )
                        .utc()
                        .format('MM-DD-YYYY')}
                    </div>
                ...
                {this.props.resultData['Issue Date'] && (
                  <div className="row">
                    ...
                    <div className="data">
                      {moment(
                        this.processDate(this.props.resultData['Issue Date'])
                      )
                        .utc()
                        .format('MM-DD-YYYY')}
                    </div>
