...
class MedicalCard extends Component {
  componentDidMount() {
    ...
    this.props.processMedicard({
      ...
      subscriptionID: config.REACT_APP_SUBSCRIPTION_ID,
    });
  }
            ...
            <div className="wrapper">
              <div className="row results_id_sig">
                <figure class="results_medcard">
                  {this.props.resultData['FrontImage'] &&
                    this.props.resultData['FrontImage'].length > 0 && (
                      <img
                        alt="idscango"
                ...
                <figure class="results_medcard">
                  {this.props.resultData['BackImage'] &&
                    this.props.resultData['BackImage'].length > 0 && (
                      <img
                        alt="idscango"
              ...
              <div className="results_data">
                <ul>
                  {Object.keys(this.props.resultData).map((key) => {
                    if (
                      this.props.resultData[key] &&
                      this.props.resultData[key].length > 0 &&
                    ...
                    if (
                      ...
                      return this.props.resultData[key].map(
                        (collapsedObject) => {
                          if (
                            collapsedObject.Label &&
                            collapsedObject.Label.length > 0
                          ) {
                            return (
                              <div className="row">
                                <div className="type">
                          ...
                          if (!('Label' in collapsedObject)) {
                            return Object.keys(collapsedObject).map(
                              (collapsedObjectKey) => {
                                if (
                                  collapsedObject[collapsedObjectKey] &&
                                  collapsedObject[collapsedObjectKey].length > 0
                                ) {
                                  return (
                                    <div className="row">
                                      <div className="type">
              ...
              <a
                ...
                onClick={() => this.resetStoreAndRedirect()}>
